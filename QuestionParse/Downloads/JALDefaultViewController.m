...
@interface JALDefaultViewController ()

@end

@implementation JALDefaultViewController
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    {
        JALFeedViewController* feed = [[JALFeedViewController alloc]init];
        [self presentViewController:feed animated:YES completion:NULL];
    }
}
...
#pragma mark - PFLogInView Delegate Methods
...
#pragma mark - PFSignUpView Delegate Methods
